...
import static model.Admin.userRepo;
...
public class Guest implements User {
    ...
    public Guest(String username, String firstName, String lastName, String password, String age, String sex, String phoneNumber, Role role) {
	...
	return "Guest{" + "username=" + username + ", firstName=" + firstName + ", password=" + password + ", age=" + age + ", sex=" + sex + ", phoneNumber=" + phoneNumber + ", role=" + role + '}';
    }

    @Override
    public Boolean register(String username, String firstName,String lastName, String password,String  age,String  sex,
	    String phoneNumber, Role role) {
	if (!password.matches("[0-9A-Za-z]{5}")) {
	    return false;
	}
	...
	Guest obj = (Guest) userRepo.get(username);
	    if(obj!=null){
